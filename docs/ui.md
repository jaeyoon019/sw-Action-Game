...
> MVP 구현 단계의 스코프는 [mvp-spec.md](mvp-spec.md)를 따릅니다. 이 문서의 모든 화면이 MVP에 포함되는 것은 아니며(MVP는 메뉴 / 게임 플레이 / 클리어 정도만 다룹니다), AI에 이 문서를 그대로 첨부하면 MVP 범위를 벗어난 화면(로그인, 인벤토리, 상점, 랭킹 등)이 생성될 수 있습니다.
